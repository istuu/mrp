				...
				<div class="row margin-top-10">
					<div class="col-md-4">
						<div class="box success"><!-- default, danger, warning, info, success -->
							...
							<div class="box-body text-center">
								<a href="{{ url('status') }}/?act=req" class="btn btn-3d btn-leaf margin-top-6">
					...
					<div class="col-md-4">
						<div class="box default"><!-- default, danger, warning, info, success -->
							...
							<div class="box-body text-center">
								<a href="{{ url('status') }}/?act=reqjab" class="btn btn-3d btn-leaf margin-top-6">
					...
					<div class="col-md-4">
						<div class="box info"><!-- default, danger, warning, info, success -->
							...
							<div class="box-body text-center">
								<a href="{{ url('status') }}/?act=res" class="btn btn-3d btn-leaf margin-top-6">
