		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="uploadSKModalLabel">Upload SK/STg</h4>
				</div>
				...
				<form action="/sk/upload" method="POST" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<div class="row">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6">
									...
									<input type="text" name="tahun_sk" id="tahun_sk" value="{{ old('tahun_sk') }}" class="form-control">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-12 col-sm-12">
									<label>Tanggal Aktivasi SK</label>
									<input type="text" name="tgl_aktivasi" id="tgl_aktivasi" value="{{ old('tgl_aktivasi') }}" class="form-control datepicker" data-format="yyyy-mm-dd" data-lang="en" data-RTL="false" >
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-12">
									<label>Upload STg</label>
									<i class="fa fa-upload"></i>
									<input class="custom-file-upload" type="file" id="file" name="file_dokumen_stg"  data-btn-text="Select a File" />
									<small class="text-muted block">File Max. 10 MB (pdf)</small>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-6 col-sm-6">
									<label>No. STg</label>
									<input type="text" name="no_sk" id="no_stg" value="{{ old('no_stg') }}" class="form-control">
								</div>
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-12 col-sm-12">
									<label>Tanggal Aktivasi STg</label>
									<input type="text" name="tgl_aktivasi_stg" id="tgl_aktivasi_stg" value="{{ old('tgl_aktivasi_stg') }}" class="form-control datepicker" data-format="yyyy-mm-dd" data-lang="en" data-RTL="false">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-6 col-sm-6">
									<label>No. Dokumen Kirim SK/STg </label>
									<input type="text" name="no_dokumen_kirim_sk" id="no_dokumen_kirim_sk" value="{{ old('no_dokumen_kirim_sk') }}" class="form-control" >
								</div>

								<div class="col-md-6 col-sm-6">
									<label>Tanggal Kirim SK/STg. </label>
									<input type="text" name="tgl_kirim_sk" class="form-control datepicker" data-format="yyyy-mm-dd" data-lang="en" data-RTL="false" value="{{ old('tgl_kirim_sk') }}" >
								</div>
							</div>
						</div>
