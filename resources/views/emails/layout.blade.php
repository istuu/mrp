  ...
  <head>
    ...
    <style type="text/css">
      ...
      @media only screen and (max-width: 699px) {
        ...
        .overlay-bg {background-image: url({{ $message->embed(public_path('vendor/mailer/images/hero/overlay-dark.png')) }});}
      }
    </style>
  </head>
            ...
            <table class="row" align="center" bgcolor="#F4F4F4" cellpadding="0">
              ...
              <tr valign="top" style="vertical-align: top;">
                <th class="column mobile-12" width="520" style="padding: 0 90px; color: #232323; font-weight: 400;">
                  ...
                  <div style="color: #666666; font-size: 18px; margin-bottom: 45px;text-align:justify"> @yield('content') </div>
                  @stack('button')
                </th>
              </tr>
            </table>
