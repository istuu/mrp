    ...
    public function export()
    {
        ...
        foreach ($mrps as $key => $mrp)
        {
            ...
            $arr = [
                ...
                'Sisa Masa Kerja' => $pegawai ? $pegawai->time_diff(Carbon::now('Asia/Jakarta'), Carbon::parse($pegawai->tgl_lahir)->addYears(56)) : NULL,
                'Masa Kerja Jbtn. Terakhir' => $pegawai ? $pegawai->time_diff(Carbon::parse($pegawai->start_date), Carbon::now('Asia/Jakarta')) : NULL,
