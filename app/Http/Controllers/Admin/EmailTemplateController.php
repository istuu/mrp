...
use App\Forms\EmailTemplateForm;
use Table;
...
class EmailTemplateController extends AdminController
{
     ...
     *
     */
    protected $columns = ['type', 'from_email', 'from_name','subject','description'];
     ...
     */
    protected $actions = [ 'create','edit', 'delete', 'detail'];
     ...
     */
     public function ajaxDatatables(){
         ...
         $table = Table::of($model)
                     ...
                     ->addColumn('description',function($model){
                         return substr(strip_tags($model->description),0,100).' ...';
                     })
                    ->make(true);
         return $table;
     }
     ...
     {
         $title = $this->title;
         $form  = $formBuilder->create(EmailTemplateForm::class, [
             'method' => 'POST',
     ...
     public function store(Request $request, FormBuilder $formBuilder)
     {
         ...
         return redirect('email_templates')->with('success','Data Berhasil ditambahkan!');
    }
    ...
    public function edit(FormBuilder $formBuilder,$id)
    {
        ...
        $form  = $formBuilder->create(EmailTemplateForm::class, [
            ...
            'url' => url('email_templates/update/'.$id)
        ]);
    ...
    */
    public function delete($id){
        ...
        return redirect('email_templates')->with('success','Data Berhasil dihapus!');
    }
}
